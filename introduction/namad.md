...
اندیکاتورهایی نظیر RSI،MACD،MFI جزو اندیکاتورهایی است که اغلب تحلیلگران برای پیدا کردن موقعیت خرید و فروش مناسب از آن‌ها استفاده می‌کنند. در این بخش خلاصه وضعیت سیگنال‌دهی سه اندیکاتور پر کاربرد را می‌توانید مشاهده کنید. اگر اندیکاتورها در وضعیت خرید یا فروش باشند شما می‌توانید بر حسب همان به خرید و فروش سهام اقدام کنید. وضعیت ختثی نیز بدان معناست که اندیکاتورها سیگنالی برای خرید و فروش نمی‌دهند و روند سهم ساید است.
{% endtab %}
